...
class BPAPR_Assets_Loader {
	...
	private function register_core() {
		...
		$this->data = array(
			'add_photos_tip'           => __( 'Add images', 'buddypress-activity-plus-reloaded' ),
			'add_photos'               => __( 'Submit images post', 'buddypress-activity-plus-reloaded' ),
			'add_remote_image'         => __( 'Add image URL', 'buddypress-activity-plus-reloaded' ),
			'add_another_remote_image' => __( 'Add another image URL', 'buddypress-activity-plus-reloaded' ),
			'add_videos'               => __( 'Add videos', 'buddypress-activity-plus-reloaded' ),
			'add_video'                => __( 'Submit video post', 'buddypress-activity-plus-reloaded' ),
			'add_links'                => __( 'Add links', 'buddypress-activity-plus-reloaded' ),
			'add_link'                 => __( 'Submit link post', 'buddypress-activity-plus-reloaded' ),
			'add'                      => __( 'Add', 'buddypress-activity-plus-reloaded' ),
			'cancel'                   => __( 'Cancel', 'buddypress-activity-plus-reloaded' ),
			'preview'                  => __( 'Preview', 'buddypress-activity-plus-reloaded' ),
			'drop_files'               => __( 'Drop files here to upload', 'buddypress-activity-plus-reloaded' ),
			'upload_file'              => __( 'Upload a file', 'buddypress-activity-plus-reloaded' ),
			'choose_thumbnail'         => __( 'Choose thumbnail', 'buddypress-activity-plus-reloaded' ),
			'no_thumbnail'             => __( 'No thumbnail', 'buddypress-activity-plus-reloaded' ),
			'paste_video_url'          => __( 'Paste video URL here', 'buddypress-activity-plus-reloaded' ),
			'paste_link_url'           => __( 'Paste link here', 'buddypress-activity-plus-reloaded' ),
			'images_limit_exceeded'    => sprintf( __( "You tried to add too many images, only %d will be posted.", 'buddypress-activity-plus-reloaded' ), BPFB_IMAGE_LIMIT ),
			// Variables
